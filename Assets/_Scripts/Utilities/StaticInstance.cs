...
/*
To make a persistent singleton:
1. If an instance of type T exists, destroy this one.
2. If an instance of type T doesn't exist, set this one as the Instance.
3. Mark object as Don't Destroy.
*/
